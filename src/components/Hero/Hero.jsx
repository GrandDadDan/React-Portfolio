...
export const Hero = () => {
  return <section className={styles.container}>
    <div className={styles.content}>
        ...
        <p className={styles.description}>Postgraduate student, motion graphics designer, fullstack developer with 3 years hands-on exerperience using React and Node.JS</p>
